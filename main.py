...
EXPRESSION_FURIGANA_COLUMN = "Expression-Furigana"
EXPRESSION_KANA_COLUMN = "Expression-Kana"
EXPRESSION_ENGLISH_COLUMN = "Expression-English"

COLUMN_ORDER = [KANJI_COLUMN, FURIGANA_COLUMN, KANA_COLUMN, "Vocab-English", VOCAB_TYPE_COLUMN, KANJI_MEANING_COLUMN,
                EXPRESSION_COLUMN, EXPRESSION_FURIGANA_COLUMN, EXPRESSION_KANA_COLUMN, EXPRESSION_ENGLISH_COLUMN]
...
def get_part_of_speech(word):
    ...
    try:
        ...
        # part_of_speech = get_first_word(part_of_speech.text) # I don't remember why I did that lol
...
def process_csv(file):
    ...
    file_contents[EXPRESSION_FURIGANA_COLUMN] = []
    file_contents[EXPRESSION_KANA_COLUMN] = []
    ...
    for val in file_contents[EXPRESSION_COLUMN]:
        file_contents[EXPRESSION_FURIGANA_COLUMN].append(furigana.add_furigana(val))
        file_contents[EXPRESSION_KANA_COLUMN].append(furigana.to_hiragana(val))
